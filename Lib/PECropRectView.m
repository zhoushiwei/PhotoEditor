...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        imageView.image = [[UIImage imageNamed:@"PEPhotoCropEditorBorder" inBundle: bundle compatibleWithTraitCollection: nil] resizableImageWithCapInsets:UIEdgeInsetsMake(23.0f, 23.0f, 23.0f, 23.0f)];
